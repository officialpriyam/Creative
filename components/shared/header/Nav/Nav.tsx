    ...
    dropdown: (
      <HeaderDropdownContent
        navigationItems={[
          {
            ...
            items: [
              ...
              },
              {
                ...
                label: "MCP",
                description: "Connect Creative to agents",
                href: "/",
                iconClassName: "-mt-1",
              },
        ...
        sideItem={{
          ...
          description: "Browse Creative examples",
        ...
        navigationItems={[
          {
            ...
            items: [
              ...
              // { icon: <ArrowRight/>, label: 'Docs', description: 'Read the docs.', href: '/', target: '_blank' },
            ],
          },
        ]}
        sideContent={
        ...
        navigationItems={[
          {
            ...
            items: [
              // { icon: <Templates />, label: 'Templates', description: 'Jumpstart your web scraping', href: '/templates' },
              {
                icon: <Changelog />,
                label: "Changelog",
                description: "Latest API updates for Creative",
                href: "/changelog",
              },
              {
                icon: <Api />,
